...
const PrintCurriculum = forwardRef<HTMLDivElement, PrintCurriculumProps>(({ curriculum }, ref) => {
            ...
            <div className="print-body grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="print-main-content col-span-2 space-y-6">
                    <div className="print-section">
                        ...
                        <p className="text-sm pl-16 leading-relaxed">{curriculum.objective}</p>
                    </div>
...
export default PrintCurriculum
