            ...
            <div className="container flex h-32 items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <Link href="/" className="flex items-center gap-2">
                        ...
                        <img className="h-12 w-48 block dark:hidden relative -top-2" src="/logos/e-curricular.png" alt="E-curricular logo" />
                        <img className="h-12 w-48 hidden dark:block relative -top-2" src="/logos/e-curricular-dark.png" alt="E-curricular logo" />
                    </Link>
                </div>
            </div>
            {children}
